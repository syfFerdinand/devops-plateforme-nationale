...
## Contexte
Des écarts de configuration existent entre dev, recette et production. Une reconstruction d'image par
...
Les tags mutables (`latest`, `main`) sont interdits en recette et en production, règle appliquée par Kyverno.

## Conséquences
- **Positives** : la recette valide réellement ce qui ira en production ; la traçabilité est exacte ; le
